...
```java
	private int load(Class<?> source) {
        ...
        //使用注解加载
        //springboot-2.4.1版本是把isComponent方法集成到register方法里
    ...
    if (checkForCircularImports && isChainedImportOnStack(configClass)) {
        ...
        try {
            ...
            for (SourceClass candidate : importCandidates) {
                //@SpringBootApplication父类中包含AutoConfigurationImportSelector，用于筛选出符合当前主类的EnableAutoConfiguration
                ...
                //@SpringBootApplication父类中包含AutoConfigurationPackages.Registrar，用于存储base包下import注解
